...
<head>
	...
	<link rel="stylesheet" href="https://use.typekit.net/dxz8yzb.css">
	<?php wp_head(); ?>
</head>
...
<body <?php body_class(); ?>>
	<?php wp_body_open(); ?>
			...
			<div class="sticky-container">
				<header class="site-header bg-dark-green" role="banner" data-sticky data-margin-top="0" data-sticky-on="small">
