...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php else:?>
		<a class="<?php if( is_home() || is_archive() || is_search() ):?> archive-permalink<?php endif;?> has-scale-img" href="<?= esc_url( get_permalink() );?>" rel="bookmark">
			<div class="grid-x grid-padding-x">
				...
				<div class="entry-header cell small-12 medium-6">
					...
					<?php endif;?>
					<h2 class="entry-title h3<?php if( !is_home() && !is_archive() && !is_search() ):?> color-white<?php else:?> color-brown<?php endif;?>">
